...
interface RoomDashboardPanelProps {
  roomName: string;
  roomArea?: number;
...
export function RoomDashboardPanel({ roomName, roomArea, roomDevices, city, country }: RoomDashboardPanelProps) {
  ...
  return (
    <div className="w-full h-full overflow-y-auto p-6 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      {/* Header - Main Panel */}
      <div className="mb-4">
        <Card className="bg-gradient-to-br from-slate-800/80 to-slate-700/80 border-slate-600 p-4">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
          {/* Weather Widget */}
          <Card className="bg-gradient-to-br from-blue-900/80 to-blue-800/80 border-blue-700 p-3 flex flex-col justify-between min-h-[160px]">
            <div>
